...
<body>
    ...
    <section id="upload"> 
        <form action="upload.php" method="post" enctype="multipart/form-data">
            ...
            <input type="submit" id="uploadbtn" value="upload" name="submit">
        </form>
    </section>
    <script>
...
if(isset($_POST["submit"])){
    ...
    $discount = $_POST["discount"];
    $phone = $_POST["phone"];
    $category = $_POST["category"]; // New field for category selection
    ...
    if($upload_ok == 0){
        ...
        if($productname !== "" && $price!=""){
            move_uploaded_file($_FILES["imageupload"]["tmp_name"],$upload_file);
            $sql ="INSERT INTO products(product_name, price, discount, product_image, category)
            VALUES('$productname', '$price', '$discount', '$product_image', '$category') ";
...
<body>
    ...
    <section id="upload"> 
        <form action="upload.php" method="post" enctype="multipart/form-data">
            ...
            <!-- Add a category selection field -->
